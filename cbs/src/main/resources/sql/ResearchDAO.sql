ResearchDAO.getResearchList = SELECT research_id AS researchId,research_topic AS researchTopic, word_count AS wordCount, file_path AS filePath, CREATEDDATE AS createdDate, a.status,b.status_name AS statusName,a.research_number, paper_version FROM research_dtls a INNER JOIN common_status b ON a.status = b.status_id where CREATEDBY =:userName
