...
public class PermissionSetupService extends BaseService {
    ...
    private final PermissionSetupDao permissionSetupDao;

    private final CommonService commonService;

    public PermissionSetupService(PermissionSetupDao permissionSetupDao, CommonService commonService) {
        this.permissionSetupDao = permissionSetupDao;
